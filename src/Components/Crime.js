        ...
        <div id="container">
            ...
            <form id="report">
                ...
                <div >
                    ...
                    <div >
                        <input type="email" id = "email" class="ip" placeholder="Enter your email" required/>
                    </div>
                </div>
                <div >
                    <div >
                        <label for = "mobile" class="lbl">Mobile Number</label>
                    </div>
                    <div >
                ...
                <div >
                    <div >
                        <label for = "text" class="lbl">Crime</label>
                    </div>
                    <div >
                        <textarea rows="5">
